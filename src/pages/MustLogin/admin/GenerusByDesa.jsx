...
const GenerusByDesa = () => {
  ...
  const fetchGenerus = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/generus/desa/${uuid}`
      );
    ...
    <>
      <div className="card">
        <div className="card-header">
          <p className="card-title">Generus Desa {desasData.desa}</p>
        </div>
        <Tabs
          activeKey={activeTab}
