...
const CustomModal = () => {
  ...
  return (
    <div>
      ...
      {/* Modal DaisyUI dengan Custom Styling */}
      <dialog ref={modalRef} id="custom_modal" className="modal custom-modal">
        <div className="modal-box bg-white">
          <div className="modal-header">
            <h3 className="text-lg font-bold">Custom Modal Title</h3>
          </div>
            ...
            <Spin spinning={loading} size="large">
              ...
              >
                ...
                <Form.Item
                  ...
                  label="Kelompok"
                  rules={[
                    { required: true, message: "Tolong pilih kelompok!" },
                  ]}
                >
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Tolong pilih status mahasiswa!",
                    },
                  ]}
                >
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Tolong masukkan nama orang tua!",
                    },
                  ]}
                >
